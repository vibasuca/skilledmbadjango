...
class Widget_Image_Layers extends Base {
	...
	public function get_title() {
		return esc_html__( 'Image Layers', 'edumall' );
	}
	...
	private function add_artboard_section() {
		$this->start_controls_section( 'artboard_section', [
			'label' => esc_html__( 'Artboard', 'edumall' ),
		] );
	...
	private function add_layers_section() {
		$this->start_controls_section( 'layers_section', [
			'label' => esc_html__( 'Layers', 'edumall' ),
		] );

		$repeater = new Repeater();

		$repeater->add_control( 'static', [
			'label' => esc_html__( 'Static Layer', 'edumall' ),
		...
		$repeater->add_control( 'loop', [
			...
			'options' => [
				...
				'rotate'          => esc_html__( 'Rotate', 'edumall' ),
				'move-horizontal' => esc_html__( 'Move - Horizontal', 'edumall' ),
				'move-vertical'   => esc_html__( 'Move - Vertical', 'edumall' ),
			],
			'default' => '',
		] );
