...
class Widget_Modern_Slider extends Carousel_Base {
	...
	public function get_title() {
		return esc_html__( 'Modern Slider', 'edumall' );
	}
	...
	private function add_content_section() {
		...
		$this->add_control( 'layers_animation', [
			'label' => esc_html__( 'Layers Animation', 'edumall' ),
		...
		$repeater->add_control( 'sub_title_heading', [
			'label'     => esc_html__( 'Sub Title', 'edumall' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		...
		$repeater->add_control( 'sub_title', [
			...
			'placeholder' => esc_html__( 'Enter your sub title', 'edumall' ),
			'default'     => '',
		] );
		...
		$repeater->add_control( 'background_animation', [
			'label'       => esc_html__( 'Background Animation', 'edumall' ),
			'label_block' => true,
			'type'        => Controls_Manager::SELECT,
			'default'     => '',
			'options'     => [
				''          => esc_html__( 'None', 'edumall' ),
				'ken-burns' => esc_html__( 'Ken Burns', 'edumall' ),
			],
		] );
		...
		$repeater->add_group_control( Group_Control_Typography::get_type(), [
			...
			'label'    => esc_html__( 'Highlight Words Typography', 'edumall' ),
			'selector' => '{{WRAPPER}} {{CURRENT_ITEM}} .title mark',
		] );

		$repeater->add_control( 'title_mark_color', [
			'label'     => esc_html__( 'Highlight Words Color', 'edumall' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
		...
		$repeater->add_control( 'button_text_border_color', [
			'label'     => esc_html__( 'Line Color', 'edumall' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
		...
		$repeater->add_control( 'button_hover_style_heading', [
			'label'     => esc_html__( 'Button Hover', 'edumall' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
