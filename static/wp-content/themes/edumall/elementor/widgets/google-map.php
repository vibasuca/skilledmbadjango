...
class Widget_Google_Map extends Base {
	...
	public function get_title() {
		return esc_html__( 'Advanced Google Map', 'edumall' );
	}
	...
	private function add_map_options_section() {
		...
		$this->add_control( 'style', [
			'label'   => esc_html__( 'Map Style', 'edumall' ),
		...
		$this->add_control( 'type', [
			'label'   => esc_html__( 'Map Type', 'edumall' ),
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'roadmap'   => esc_html__( 'Roadmap', 'edumall' ),
				'satellite' => esc_html__( 'Satellite', 'edumall' ),
				'hybrid'    => esc_html__( 'Hybrid', 'edumall' ),
				'terrain'   => esc_html__( 'Terrain', 'edumall' ),
			],
			'default' => 'roadmap',
		] );

		$this->add_control( 'zoom_level', [
			'label'       => esc_html__( 'Zoom Level', 'edumall' ),
			'placeholder' => '12',
		...
		$this->add_control( 'scrollwheel', [
			'label'   => esc_html__( 'Mouse Scroll Wheel Zoom', 'edumall' ),
			'type'    => Controls_Manager::SWITCHER,
			'default' => 'yes',
		] );

		$this->add_control( 'draggable', [
			'label'   => esc_html__( 'Draggable', 'edumall' ),
			'type'    => Controls_Manager::SWITCHER,
			'default' => 'yes',
		] );

		$this->add_control( 'map_controls_heading', [
			'label'     => esc_html__( 'Controls', 'edumall' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );

		$this->add_control( 'zoom_control', [
			'label' => esc_html__( 'Zoom Control', 'edumall' ),
			'type'  => Controls_Manager::SWITCHER,
		] );

		$this->add_control( 'scale_control', [
			'label' => esc_html__( 'Scale Control', 'edumall' ),
			'type'  => Controls_Manager::SWITCHER,
		] );

		$this->add_control( 'fullscreen_control', [
			'label' => esc_html__( 'Fullscreen Control', 'edumall' ),
			'type'  => Controls_Manager::SWITCHER,
		] );

		$this->add_control( 'street_view_control', [
			'label' => esc_html__( 'Street View Control', 'edumall' ),
			'type'  => Controls_Manager::SWITCHER,
		] );
	...
	private function add_map_markers_section() {
		$this->start_controls_section( 'markers_section', [
			'label' => esc_html__( 'Markers', 'edumall' ),
		] );

		$this->add_control( 'marker_style', [
			'label'       => esc_html__( 'Marker Style', 'edumall' ),
			'description' => esc_html__( 'Select default style for all markers', 'edumall' ),
			'type'        => Controls_Manager::SELECT,
			'options'     => [
				'icon'   => esc_html__( 'Icon', 'edumall' ),
				'signal' => esc_html__( 'Signal', 'edumall' ),
			],
			'default'     => 'icon',
		] );

		$this->add_control( 'marker_icon', [
			'label'     => esc_html__( 'Marker Icon', 'edumall' ),
		...
		$repeater->start_controls_tab( 'marker_content_tab', [
			'label' => esc_html__( 'Marker', 'edumall' ),
		] );

		$repeater->add_control( 'address', [
			'label'       => esc_html__( 'Address or Coordinate', 'edumall' ),
		...
		$repeater->start_controls_tab( 'marker_popup_tab', [
			'label' => esc_html__( 'Popup', 'edumall' ),
		] );

		$repeater->add_control( 'overlay_display', [
			'label'   => esc_html__( 'Display', 'edumall' ),
			'type'    => Controls_Manager::SELECT,
			'options' => [
				''       => esc_html__( 'Hover', 'edumall' ),
				'always' => esc_html__( 'Always', 'edumall' ),
			],
			'default' => '',
		] );
		...
		$repeater->add_control( 'image', [
			...
			'description' => esc_html__( 'Choose an image that displays on left info box', 'edumall' ),
			'type'        => Controls_Manager::MEDIA,
			'classes'     => 'edumall-control-media-auto',
		] );
		...
		$this->add_group_control( Group_Control_Image_Size::get_type(), [
			'label'     => esc_html__( 'Popup Image Size', 'edumall' ),
	...
	private function add_map_markers_style_section() {
		$this->start_controls_section( 'markers_popup_style_section', [
			'label' => esc_html__( 'Markers Popup', 'edumall' ),
	...
	private function get_map_style() {
		return [
			'no_label_bright_colors'  => esc_html__( 'No Label Bright Colors', 'edumall' ),
			'grayscale'               => esc_html__( 'Grayscale', 'edumall' ),
			'subtle_grayscale'        => esc_html__( 'Subtle Grayscale', 'edumall' ),
			'apple_paps_esque'        => esc_html__( 'Apple Maps-esque', 'edumall' ),
			'pale_dawn'               => esc_html__( 'Pale Dawn', 'edumall' ),
			'midnight_commander'      => esc_html__( 'Midnight Commander', 'edumall' ),
			'blue_water'              => esc_html__( 'Blue Water', 'edumall' ),
			'retro'                   => esc_html__( 'Retro', 'edumall' ),
			'paper'                   => esc_html__( 'Paper', 'edumall' ),
			'ultra_light_with_labels' => esc_html__( 'Ultra Light with Labels', 'edumall' ),
			'shades_of_grey'          => esc_html__( 'Shades Of Grey', 'edumall' ),
			'easy_light'              => esc_html__( 'Easy Light', 'edumall' ),
			'wy'                      => esc_html__( 'WY', 'edumall' ),
		];
	}
