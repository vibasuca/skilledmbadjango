(
	function( $ ) {
		...
		var EdumallTypedHeadlineHandler = function( $scope, $ ) {
		...
		$( window ).on( 'elementor/frontend/init', function() {
			elementorFrontend.hooks.addAction( 'frontend/element_ready/tm-typed-headline.default', EdumallTypedHeadlineHandler );
		} );
	}
)( jQuery );
