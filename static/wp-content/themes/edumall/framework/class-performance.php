...
if ( ! class_exists( 'Edumall_Performance' ) ) {
	class Edumall_Performance {
		...
		function disable_emojis() {
			$enable = Edumall::setting( 'disable_emoji' );
			if ( ! $enable ) {
				return;
			}
		...
		function disable_embeds_code_init() {
			$enable = Edumall::setting( 'disable_embeds' );
			if ( ! $enable ) {
				return;
			}
	...
	Edumall_Performance::instance()->initialize();
}
