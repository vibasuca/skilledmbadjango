...
if ( ! class_exists( 'Edumall_FAQ_Group_List_Walker' ) ) {
	class Edumall_FAQ_Group_List_Walker extends Walker {
		...
		public function start_el( &$output, $cat, $depth = 0, $args = array(), $current_object_id = 0 ) {
			...
			$output .= '"><a href="' . get_term_link( $cat_id, $this->tree_type ) . '">' . apply_filters( 'list_faq_groups', $cat->name, $cat ) . '</a>';
