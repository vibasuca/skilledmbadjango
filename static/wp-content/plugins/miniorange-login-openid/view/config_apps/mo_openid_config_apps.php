		...
		function enable_app(a,app_name,toggle) {
			...
			jQuery.ajax({
				...
				success: function (result) {
					...
					if (true) {
						if (a.checked == true) {
							if (app_name == 'facebook' || app_name == 'twitter' || app_name == 'snapchat' || app_name == 'dribbble' || app_name == 'discord' || app_name == 'google' || app_name == 'amazon' || app_name == 'vkontakte' || app_name == 'linkedin' || app_name == 'yahoo') {
